...
```
This notebook explores the Corpora data. And it answers the questions in Week 1 quiz of [Data Sciencen Capstone](https://www.coursera.org/learn/data-science-project).
...
#### 3-1 Occurance of "love" over "hate"
